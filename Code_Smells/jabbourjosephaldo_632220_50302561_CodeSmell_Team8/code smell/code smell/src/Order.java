...
public class Order {
    ...
    public double calculateTotalPrice() {
        ...
        // Replace with (see OrderCalculator.java): 
        return OrderCalculations.calculateTotalPrice(items, hasGiftCard());
    }
    ...
    public void sendConfirmationEmail() {
        ...
        EmailDetails emailDetails = new EmailDetails(customerEmail, "Order Confirmation", message);
